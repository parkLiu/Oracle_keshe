...
public class classalterDialog extends JDialog implements ActionListener {
    ...
    public classalterDialog() throws SQLException, ClassNotFoundException {
    ...
    private void initdia() {
        ...
        jLabel2=new JLabel("修改后班级名称");
        jLabel3=new JLabel("修改后导员名字");
        jLabel4=new JLabel("修改后班级主课程");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==quxiaoButton){
            ...
            String sql1="delete from class where cno='"+jTextField1.getText()+"'";
            String sql2="insert into class values('"+jTextField1.getText()+"','"
