...
public class schooladdDialog extends JDialog implements ActionListener {
    ...
    public schooladdDialog() throws SQLException, ClassNotFoundException {
...
//,,,,,,,,
        ...
        jLabel4=new JLabel("出生日期");
        jLabel5=new JLabel("班级编号");
        jLabel6=new JLabel("联系电话");
        jLabel7=new JLabel("报名日期");
        jLabel8=new JLabel("家庭地址");
        jLabel9=new JLabel("备注");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==quxiaoButton){
            ...
            String sql="insert into student values('"+jTextField1.getText()+"','"
                    ...
                    +"')";
            String sql1="insert into stu values('"+jTextField1.getText()+"','123')";
            try {
