...
public class gradedeleteDialog extends JDialog implements ActionListener {
    JLabel jLabel=new JLabel("删除");
    JTextField jTextField=new JTextField(10);
    JButton jButton1=new JButton("取消");
    JButton jButton2=new JButton("确定");
    public gradedeleteDialog(){
        initjf();
        init();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==jButton1){
            ...
            String sql="delete from grade where gno='"+jTextField.getText()+"'";
