...
public class mangelogin extends JFrame implements ActionListener {
    Connection con;
...
//    JButton registButton=new JButton("注册");
    public mangelogin() throws SQLException {
        initJfram();
        init();
    ...
    private void init() {
        ...
        loginButton.setBounds(240, 300, 90, 40);
...
//        registButton.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        System.out.println(con.getClass().getName());
            ...
            String sql="select * from manger where username="+"'"+username+"'"+" and password="+"'"+password+"'";
            try {
               presql=con.prepareStatement(sql);
               rs=presql.executeQuery();
               if (rs.next()){
                   System.out.println("登录成功");
                   String rizhisql="insert into rizhi values('"+username+"','"+password+"',sysdate)";
