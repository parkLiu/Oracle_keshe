...
public class gradeaddDialog extends JDialog implements ActionListener {
    ...
    public gradeaddDialog() throws SQLException, ClassNotFoundException {
...
//每个学生成绩有、、、、课程名称和。
        ...
        jLabel2=new JLabel("成绩类型");
        jLabel3=new JLabel("班级编号");
        jLabel4=new JLabel("学生学号");
        jLabel5=new JLabel("课程名称");
        jLabel6=new JLabel("成绩");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==quxiaoButton){
            ...
            String sql="insert into grade values('"+jTextField1.getText()+"','"
